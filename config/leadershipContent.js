module.exports = `<div class="leadership-grid">
  ...
  <article class="leadership-card">
    ...
    <p class="leadership-name">Mrs. Peace Egborode</p>
  </article>
  <article class="leadership-card">
    <img src="/images/leadership/vp-academics.jpg" alt="Mrs. Rahab Sallamu — Vice Principal (Academics)" class="leadership-photo" width="220" height="293" onerror="this.onerror=null;this.src='/images/leadership/placeholder.svg';">
    <h3>Vice Principal (Academics)</h3>
    <p class="leadership-name">Mrs. Rahab Sallamu</p>
  </article>
</div>`;
